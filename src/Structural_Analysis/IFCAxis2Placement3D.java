	...
	FileInputStream fis = new FileInputStream(f);
        ...
        while (fis.available() > 0) 
        {
            ...
            {       
               ...
               if(tag.equalsIgnoreCase("IFCAXIS2PLACEMENT3D"))
               {
                    d=data.split(",");
                   ...
                   if(id.equalsIgnoreCase(str1))
               {
                 ...
                 ref2=ref2.substring(0,ref2.length()-1);
                   //System.out.println(ref);
                    ...
                    IFCCartesianPoint is=new IFCCartesianPoint();
                   String g1=is.read(ref,sss);
                   
                   IFCDirection im=new IFCDirection();
                   String g2=im.read(ref1,sss);
                   String g3=im.read(ref2,sss);
