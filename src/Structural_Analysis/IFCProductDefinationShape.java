 ...
 * @author rk nanda
 */
public class IFCProductDefinationShape 
{
    ...
    Connect m;
   public  IFCProductDefinationShape() throws Exception
   {
	...
	FileInputStream fis = new FileInputStream(f);
        ...
        while (fis.available() > 0) 
        {
            ...
            {       
               ...
               if(tag.equalsIgnoreCase("IFCPRODUCTDEFINITIONSHAPE"))
               {
                    d=data.split(",");
                   ...
                   if(id.equalsIgnoreCase(str1))
               {
                  ...
                  ref=ref.substring(1,ref.length()-2);
                   ...
                   System.out.println(ref);
                    IFCTopologyRepresentation is=new IFCTopologyRepresentation();
