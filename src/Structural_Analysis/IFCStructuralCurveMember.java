...
public class IFCStructuralCurveMember 
{
    ...
    Connect m;
   public  IFCStructuralCurveMember() throws Exception
   {
	...
	FileInputStream fis = new FileInputStream(f);
        ...
        while (fis.available() > 0) 
        {
            ...
            {       
               ...
               if(tag.equalsIgnoreCase("IFCSTRUCTURALCURVEMEMBER"))
               {
                    d=data.split(",");
                   ...
                   if(id.equalsIgnoreCase(str1))
               {
                  ...
                  ref2=d[6];
                   System.out.println(ref2);
                    ...
                    IFCProductDefinationShape is=new IFCProductDefinationShape();
                   String g=is.read(ref2,sss);
