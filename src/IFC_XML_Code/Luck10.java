...
public class Luck10 {
 ...
 public  Luck10()throws Exception
   {
...
public void readFile(String r)throws Exception
   ...
   String gid;
        ...
        NodeList nodeList = document.getElementsByTagName("IfcSlab");
          k="|---------------------------------------------------------------|\n|                                                               |\n|                                                               |\n|                            SCRUTINIZER                        | ";
            writeFile(ss,k);
...
k="|                                                               |\n|                                                               |\n|                                                               |\n|-----------------------Depth Validation------------------------| ";
      ...
      break;
        ...
        System.out.println("Report of Validation is Being Created as MAinSlab.BIM File");
        }
