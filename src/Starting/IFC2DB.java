...
import Structural_Analysis.IFCRELASSOCIATESPROFILEPROPERTIES;
import Structural_Analysis.IFCRelconnectsStructuralActivity;
import Structural_Analysis.IFCSTRUCTURALPROFILEPROPERTIES;
import Structural_Analysis.IFCStructuralCurveMember;
import Structural_Analysis.Splitting;
import java.io.File;
        ...
        while (fis.available() > 0) 
        {
            ...
            {       
                ...
                switch(tag.trim())
                {
                    ...
                    c.createSlab(hashno,d[0].replace("'",""),OwnerHistoryHashNo,LocalPlacementHashNo,ProductDefinationHashNo,fileId);
                    c.DmlStatement();    
                    break;
